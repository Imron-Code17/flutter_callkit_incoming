...
object CallkitConstants {
    ...
    const val ACTION_CALL_FOLLOW_UP =
            "com.hiennv.flutter_callkit_incoming.ACTION_CALL_FOLLOW_UP"
    ...
    const val EXTRA_CALLKIT_SUBTITLE = "EXTRA_CALLKIT_SUBTITLE"
    const val EXTRA_CALLKIT_TIMER = "EXTRA_CALLKIT_TIMER"
    const val EXTRA_CALLKIT_SENDERMESSAGE = "EXTRA_CALLKIT_SENDERMESSAGE"
    ...
    const val EXTRA_CALLKIT_TEXT_FOLLOW_UP = "EXTRA_CALLKIT_TEXT_FOLLOW_UP"
    const val EXTRA_CALLKIT_URL_FOLLOW_UP = "EXTRA_CALLKIT_URL_FOLLOW_UP"
    const val EXTRA_CALLKIT_TEXT_DECLINE = "EXTRA_CALLKIT_TEXT_DECLINE"
    const val EXTRA_CALLKIT_URL_DECLINE = "EXTRA_CALLKIT_URL_DECLINE"
    const val EXTRA_CALLKIT_FCM_DATA = "EXTRA_CALLKIT_FCM_DATA"
    const val EXTRA_CALLKIT_TARGET_ROUTE = "targetRoute"
    ...
    const val EXTRA_CALLKIT_MISSED_CALL_TITLE = "EXTRA_CALLKIT_MISSED_CALL_TITLE"
    const val EXTRA_CALLKIT_MISSED_CALL_SUBTITLE = "EXTRA_CALLKIT_MISSED_CALL_SUBTITLE"
    const val EXTRA_CALLKIT_MISSED_CALL_TIMER = "EXTRA_CALLKIT_MISSED_CALL_TIMER"
    const val EXTRA_CALLKIT_MISSED_CALL_SENDERMESSAGE = "EXTRA_CALLKIT_MISSED_CALL_SENDERMESSAGE"
    ...
    const val EXTRA_CALLKIT_SENDER_TEXT_COLOR = "EXTRA_CALLKIT_SENDER_TEXT_COLOR"
